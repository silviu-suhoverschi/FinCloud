...
class TransactionBase(BaseModel):
    ...
    fee: Decimal = Field(
        default=Decimal("0"), ge=0, description="Transaction fee"
    )
    tax: Decimal = Field(
        default=Decimal("0"), ge=0, description="Transaction tax"
    )
    currency: str = Field(
...
class TransactionUpdate(BaseModel):
    ...
    total_amount: Optional[Decimal] = Field(None, description="Total transaction amount")
