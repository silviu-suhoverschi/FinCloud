...
class PortfolioTransaction(Base):
    ...
    __table_args__ = (
        ...
        CheckConstraint("tax >= 0", name="chk_tax_non_negative"),
        Index(
            "idx_portfolio_transactions_portfolio_id",
            "portfolio_id",
        ...
        Index(
            "idx_portfolio_transactions_date", "date", postgresql_ops={"date": "DESC"}
        ),
        Index(
            "idx_portfolio_transactions_created_at",
            "created_at",
            postgresql_ops={"created_at": "DESC"},
        ),
        # Composite indexes for common query patterns
        Index(
            "idx_portfolio_transactions_portfolio_date",
            "portfolio_id",
            "date",
        ...
        Index(
            "idx_portfolio_transactions_asset_date",
            "asset_id",
            "date",
            postgresql_ops={"date": "DESC"},
            postgresql_where="deleted_at IS NULL",
        ...
        Index(
            "idx_portfolio_transactions_portfolio_type",
            "portfolio_id",
            "type",
            "date",
            postgresql_ops={"date": "DESC"},
